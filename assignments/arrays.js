...
console.log("The car was made in " + inventory[32].car_year + " by " + inventory[32].car_make + " and the model is: " + inventory[32].car_model);
...
let carModels = inventory.map(object => object.car_model);
let carModelsSorted = carModels.sort();
console.log(carModelsSorted);

// ==== Challenge 4 ====
// The accounting team needs all the years from every car on the lot. Create a new array from the dealer data containing only the car years and log the result in the console.
let carYears = inventory.map(object => object.car_year);
...
let BMWAndAudi = inventory.filter(object => object.car_make == "Audi" || object.car_make == "BMW");
